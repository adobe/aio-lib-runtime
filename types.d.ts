 ...
 * @property [triggers] - filter list of triggers to deploy, e.g. ['name1', ..]
 * @property [rules] - filter list of rules to deploy, e.g. ['name1', ..]
 * @property [apis] - filter list of apis to deploy, e.g. ['name1', ..]
 * @property [dependencies] - filter list of package dependencies to deploy, e.g. ['name1', ..]
 */
declare type FilterEntities = {
    actions?: any[];
...
/**
 * @property [filterEntities] - add filters to deploy only specified OpenWhisk entities
 * @property [useForce] - force deploy of actions
 */
 ...
 */
declare function deployActions(config: any, deployConfig?: DeployConfig, logFunc?: any): Promise<object>;
 ...
 * @param _isLocalDev - local dev UNUSED
 * @param legacy - default false add backwards compatibility for urls keys.
 * @returns urls of actions
 */
declare function getActionUrls(appConfig: any, isRemoteDev: boolean, _isLocalDev: boolean, legacy: boolean): any;
